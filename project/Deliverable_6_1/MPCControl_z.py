...
class MPCControl_z(MPCControl_base):
    ...
    def _setup_controller(self) -> None:
        ...
        #All 3 noise scenarious have a solution, but none of the stabilizes under 4 seconds
        ...
        # Tightened robust ground constraint 
        z_s = float(self.xs[1])
        z_margin = 0.5
    ...
    def get_u(self, x0: np.ndarray, x_target: np.ndarray = None, u_target: np.ndarray = None):
        ...
        # propagate nominal state with nominal dynamics 
